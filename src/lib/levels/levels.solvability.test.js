...
const KNOWN_UNSOLVABLE_BUGS = new Set([
    // L2 fixed in phase-04 (commit: Act 1 redesign).
    3,  // redesign in phase-05-redesign-act2-l3-l4.md
    4,  // redesign in phase-05-redesign-act2-l3-l4.md
    9,  // redesign in phase-08-redesign-act5-l9-l10.md
